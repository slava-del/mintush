...
const changes = [
  ...
  "решения будут приниматься быстрее и в правильный момент",
...
const tariffs = [
  ...
  },
  {
    title: "ПОД КЛЮЧ",
    price: "$...",
    audience: "Для тех, кому нужен быстрый результат и готовая система",
    items: [
      "4 практических руководства",
      "4 вебинара",
      "шаблон внедрения",
      "индивидуальная консультация с экспертом",
      "помощь эксперта в создании бизнес-системы вашего бизнеса",
    ],
...
const systemBase = ["отлаженные процессы", "сбалансированная команда", "отслеживаемые показатели", "понятные задачи"]
        ...
        <div className="h-[calc(100vh-1.5rem)] sm:h-[calc(100vh-2rem)] md:h-[calc(100vh-3rem)] overflow-x-hidden overflow-y-auto rounded-[28px] border border-[#e7d2ad]/45 bg-[#050505] shadow-[0_40px_140px_rgba(0,0,0,0.65)]">
          ...
          <section className="relative min-h-[calc(100vh-3.5rem)] overflow-hidden px-6 pb-14 pt-12 md:px-10 md:pb-16 md:pt-14">
            <div className="absolute inset-0">
              <Image
                src="/images/course-management.jpg"
                alt="Управление бизнесом"
                fill
                priority
            ...
            <div className="relative z-10 mx-auto max-w-6xl">
              <div className="flex flex-wrap items-center justify-between gap-3">
                <p className="text-[11px] font-semibold uppercase tracking-[0.14em] text-white/45">/education/business-management</p>
              ...
              <p className="mt-6 max-w-4xl text-[20px] leading-[1.3] text-white/74 md:text-[28px]">
                Работающие подходы, которые помогут владельцу Малого или Среднего бизнеса начать управлять компанией без
          ...
          <section className="mx-4 mb-6 rounded-[24px] border border-white/10 bg-[#070707] p-6 md:mx-10 md:p-9">
            <div className="grid gap-8 lg:grid-cols-2">
              <div>
                <p className="text-[16px] leading-[1.35] text-white/72">
                  Если бизнес держится на вас, а операционка постоянно требует внимания, компании не хватает
                  управленческого каркаса. Этот курс поможет выстроить управление так, чтобы бизнес работал предсказуемо:
                  по цифрам, срокам и качеству.
                </p>

                <p className="mt-6 text-[11px] font-semibold uppercase tracking-[0.12em] text-[#e7d2ad]">Эксперт курса</p>
              ...
              <div className="rounded-[18px] border border-[#e7d2ad]/30 bg-[#0e0e0e] p-5">
                <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-[#e7d2ad]">Что изменится после курса</p>
          ...
          <section className="mx-4 mb-6 rounded-[24px] border border-white/10 bg-[#030303] p-6 md:mx-10 md:p-9">
            <div className="grid gap-8 lg:grid-cols-2">
              <div>
                ...
                <p className="mt-4 text-[16px] leading-[1.34] text-white/70">
                  Курс для владельцев и руководителей малого и среднего бизнеса, которые хотят:
                </p>
              ...
              <div>
                <p className="text-[11px] font-semibold uppercase tracking-[0.12em] text-[#e7d2ad]">
                  4 практических руководства и 4 вебинара
                </p>
                <div className="mt-3 grid gap-2">
          ...
          <section className="mx-4 mb-6 rounded-[24px] border border-white/10 bg-[#030303] p-6 md:mx-10 md:p-9">
            <div className="grid gap-8 lg:grid-cols-2">
              ...
              <div>
                <h3 className="text-[30px] font-extrabold leading-[1.03] tracking-[-0.03em] text-white md:text-[42px]">
                  Бизнес-система это не бюрократия
                </h3>
                <p className="mt-4 text-[16px] leading-[1.33] text-white/72">Это механизм достижения целей, его база:</p>
                <div className="mt-3 grid gap-2">
                  {systemBase.map((item) => (
                    <p key={item} className="text-[16px] leading-[1.33] text-[#e7d2ad]">
                      {item}
