...
export const highlights: Highlight[] = [
  {
    ...
    description: "Строим систему управления: роли, процессы и ритм решений.",
  },
  {
    top: "50+ кейсов",
    bottom: "в практике",
    description: "Реальные внедрения: KPI, делегирование, контроль, оргструктура.",
  },
  {
    top: "4 встречи",
    bottom: "в месяц",
    description: "Регулярные разборы, практика и обратная связь по задачам.",
  },
  {
    top: "3 уровня",
    bottom: "зрелости",
    description: "От руководителя к стратегу через понятную траекторию роста.",
  },
];
